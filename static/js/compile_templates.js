...
output += runtime.suppressValue((lineno = 342, colno = 42, runtime.callWrap(t_5, "properties_selector", context, [runtime.contextOrFrameLookup(context, frame, "points_spread"),"points_list","POINTS SPREAD","This will open a popup that will let you customize your points spread."])), env.opts.autoescape);
output += "\n                    ";
