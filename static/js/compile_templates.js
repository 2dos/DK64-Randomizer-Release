...
["id", "name"], 
["tooltip", "default_checked", "altered_name", "hidden", "external_link"], 
...
t_22 += "\n    </label>\n    ";
if(runtime.contextOrFrameLookup(context, frame, "external_link") != "") {
t_22 += "\n        <a href=\"";
t_22 += runtime.suppressValue(runtime.contextOrFrameLookup(context, frame, "external_link"), env.opts.autoescape);
t_22 += "\" target=\"_blank\" rel=\"noopener noreferrer\" class=\"btn btn-sm\">\n            <i class=\"fas fa-external-link-alt\"></i>\n        </a>\n    ";
;
}
t_22 += "\n</div>\n";
;
...
frame = frame.push();
var t_27 = (lineno = 252, colno = 27, runtime.callWrap(runtime.contextOrFrameLookup(context, frame, "range"), "range", context, [l_min_value,l_max_value + 1]));
if(t_27) {t_27 = runtime.fromIterator(t_27);
var t_26 = t_27.length;
for(var t_25=0; t_25 < t_27.length; t_25++) {
var t_28 = t_27[t_25];
...
output += "\n                ";
output += "\n                ";
output += runtime.suppressValue((lineno = 112, colno = 31, runtime.callWrap(t_4, "toggle_input", context, ["season5_crate_rando","Seasonal Crates","Shuffle the locations of to specific locations based on the Seasonal Settings.",runtime.makeKeywordArgs({"external_link": "https://docs.google.com/spreadsheets/d/1Nnfgn7PdlCjY-n1cs1fuxp3bRsx3S-sYk5gmVdVnLtw/edit?usp=sharing"})])), env.opts.autoescape);
...
output += "\n                ";
output += runtime.suppressValue((lineno = 169, colno = 31, runtime.callWrap(t_4, "toggle_input", context, ["season5_door_rando","Seasonal Doors","Hint Doors are moved to 5 specific locations designed for the Seasonal settings",runtime.makeKeywordArgs({"external_link": "https://docs.google.com/spreadsheets/d/1Nnfgn7PdlCjY-n1cs1fuxp3bRsx3S-sYk5gmVdVnLtw/edit?usp=sharing"})])), env.opts.autoescape);
...
output += runtime.suppressValue((lineno = 195, colno = 31, runtime.callWrap(t_4, "toggle_input", context, ["boss_location_rando","Shuffle Boss Location","The boss you can get in a level is different than normal."])), env.opts.autoescape);
...
output += runtime.suppressValue((lineno = 217, colno = 41, runtime.callWrap(t_10, "dropdown_multiselector", context, [runtime.contextOrFrameLookup(context, frame, "bosses"),"bosses","Allowed Bosses","This will open a popup that will let you customize what bosses are allowed to appear in your seed.&#10;This defaults to All options.",12,1])), env.opts.autoescape);
output += "\n            </div>\n        </div>\n        <div class=\"col border panel\">\n            <h2 class=\"title\">ENEMIES</h2>\n            <div class=\"flex-container\">\n                ";
output += runtime.suppressValue((lineno = 223, colno = 41, runtime.callWrap(t_10, "dropdown_multiselector", context, [runtime.contextOrFrameLookup(context, frame, "enemies"),"enemies","Shuffled Enemies","This will open a popup that will let you customize what enemies appear in the game.&#10;This defaults to All options.",16,1])), env.opts.autoescape);
...
output += runtime.suppressValue((lineno = 250, colno = 31, runtime.callWrap(t_4, "toggle_input", context, ["enemy_speed_rando","Random Enemy Speed","Enemy speeds are randomized."])), env.opts.autoescape);
output += "\n                ";
output += runtime.suppressValue((lineno = 251, colno = 31, runtime.callWrap(t_4, "toggle_input", context, ["randomize_enemy_sizes","Random Enemy Size","The size of enemies is randomized."])), env.opts.autoescape);
output += "\n            </div>\n            <hr />\n            <h2 class=\"title\">BONUS BARRELS</h2>\n            <div class=\"flex-container\">\n                ";
output += runtime.suppressValue((lineno = 256, colno = 41, runtime.callWrap(t_10, "dropdown_multiselector", context, [runtime.contextOrFrameLookup(context, frame, "minigames"),"minigames_list","Shuffled Bonus Barrels","This will open a dropdown that will let you customize what Bonus Games are in the pool.",18,1])), env.opts.autoescape);
output += "\n                <div class=\"spacer\"></div>\n                ";
output += runtime.suppressValue((lineno = 258, colno = 31, runtime.callWrap(t_4, "toggle_input", context, ["disable_hard_minigames","Disable Hard Minigames","Disables harder minigames."])), env.opts.autoescape);
...
output += runtime.suppressValue((lineno = 271, colno = 31, runtime.callWrap(t_4, "toggle_input", context, ["alt_minecart_mayhem","Alternate Minecart Mayhem","Changes Minecart Mayhem to be a coin collection minigame instead of an endurance minigame."])), env.opts.autoescape);
...
output += runtime.suppressValue((lineno = 356, colno = 42, runtime.callWrap(t_6, "properties_selector", context, [runtime.contextOrFrameLookup(context, frame, "helm_hurry_items"),"helmhurry_list","HELM HURRY SELECTOR","This will open a popup that will let you customize what how much time each item will give you."])), env.opts.autoescape);
output += "\n                ";
...
output += runtime.suppressValue((lineno = 372, colno = 41, runtime.callWrap(t_10, "dropdown_multiselector", context, [runtime.contextOrFrameLookup(context, frame, "hard_mode"),"hard_mode","Hard Mode","This will open a dropdown that will let you customize what hard mode Options are active.",10])), env.opts.autoescape);
output += "\n                ";
output += runtime.suppressValue((lineno = 373, colno = 41, runtime.callWrap(t_10, "dropdown_multiselector", context, [runtime.contextOrFrameLookup(context, frame, "hard_bosses"),"hard_bosses","Hard Bosses","This will open a dropdown that will let you customize what bosses are made harder.",10])), env.opts.autoescape);
...
output += "\n                            <option id=\"req_pearl\" value=\"req_pearl\">\n                                Pearls\n                            </option>\n                            <option id=\"req_cb\" value=\"req_cb\">\n                                Colored Bananas\n                            </option>\n                        </select>\n                        <input min=\"1\"\n                                max=\"3500\"\n                                name=\"progressive_hint_count\"\n                                id=\"progressive_hint_count\"\n                                display_name=\"Progressive Hint 35 Requirement\"\n                                class=\"form-control center-div\"\n                                type=\"number\"\n                                data-toggle=\"tooltip\"\n                                title=\"Item count requirement for the 35th hint with progressive Hints.\"\n                                default=\"1\"\n                                placeholder=\"1\"/>\n                    </div>\n                    <div style=\"display: flex; align-items: center;\">\n                        <div style=\"margin-right: 10px; font-weight: bold;\">Pace:</div>\n                        <select name=\"progressive_hint_algorithm\"\n                                id=\"progressive_hint_algorithm\"\n                                display_name=\"Progressive Hint Algorithm\"\n                                class=\"form-select center-div\"\n                                aria-label=\"Progressive Hint Algorithm\"\n                                data-toggle=\"tooltip\"\n                                title=\"How quickly progressive hints are unlocked.\">\n                            <option value=\"slow\">\n                                Slow\n                            </option>\n                            <option selected value=\"medium\">\n                                Medium\n                            </option>\n                            <option value=\"fast\">\n                                Fast\n                            </option>\n                        </select>\n                    </div>\n                </div>\n                <div class=\"item-select\">\n                    <p class=\"select-title\" style=\"margin-bottom:5px;\">Hint Door Locking Item</p>\n                    <div class=\"d-flex select-number-container\" id=\"hint_door_item_container\">\n                        <select name=\"hint_door_item\"\n                                id=\"hint_door_item\"\n                                display_name=\"Hint Door Locking Item\"\n                                class=\"form-select center-div\"\n                                aria-label=\"Hint Door Locking Item\"\n                                data-toggle=\"tooltip\"\n                                title=\"The item required access hint doors. \">\n                            <option selected id=\"off\" value=\"off\" title=\"\">\n                                Not Locked\n                            </option>\n                            <option id=\"req_gb\" value=\"req_gb\">\n                                Golden Bananas\n                            </option>\n                            <option id=\"req_bp\" value=\"req_bp\">\n                                Blueprints\n                            </option>\n                            <option id=\"req_key\" value=\"req_key\">\n                                Keys\n                            </option>\n                            <option id=\"req_medal\" value=\"req_medal\">\n                                Medals\n                            </option>\n                            <option id=\"req_crown\" value=\"req_crown\">\n                                Crowns\n                            </option>\n                            <option id=\"req_fairy\" value=\"req_fairy\">\n                                Fairies\n                            </option>\n                            <option id=\"req_rainbowcoin\" value=\"req_rainbowcoin\">\n                                Rainbow Coins\n                            </option>\n                            ";
output += "\n                            <option id=\"req_pearl\" value=\"req_pearl\">\n                                Pearls\n                            </option>\n                            <option id=\"req_cb\" value=\"req_cb\">\n                                Colored Bananas\n                            </option>\n                        </select>\n                        <input min=\"1\"\n                                max=\"3500\"\n                                name=\"hint_door_item_count\"\n                                id=\"hint_door_item_count\"\n                                display_name=\"Final Level Hint Door Requirement\"\n                                class=\"form-control center-div\"\n                                type=\"number\"\n                                data-toggle=\"tooltip\"\n                                title=\"Item count for the last level's hint doors.\"\n                                default=\"1\"\n                                placeholder=\"1\"/>\n                    </div>\n                </div>\n                <div class=\"item-select\">\n                    <p class=\"select-title\" style=\"margin-bottom:5px;\">Pause Menu Hints</p>\n                    <div class=\"d-flex select-number-container\" id=\"pause_hints_container\">\n                        <select name=\"pause_hints_setting\"\n                                id=\"pause_hints_setting\"\n                                display_name=\"Pause Menu Hints\"\n                                class=\"form-select center-div\"\n                                aria-label=\"Pause Menu Hints\"\n                                data-toggle=\"tooltip\"\n                                title=\"Determines whether the pause menu will display hints, and how that screen behaves:&#10;- Enabled: Pause Menu will display hints on the last screen.&#10;- Disabled: The pause menu hints screen will not be available&#10;- Cooldown timer: Upon viewing the pause hint screen with new hints unlocked, you will be locked out of closing the pause menu for a user-defined amount of seconds per set of 4 unlocked hints.\">\n                            <option selected id=\"normal\" value=\"normal\" title=\"\">\n                                Enabled\n                            </option>\n                            <option id=\"off\" value=\"off\">\n                                Disabled\n                            </option>\n                            <option id=\"lockout\" value=\"lockout\">\n                                Cooldown timer\n                            </option>\n                        </select>\n                        <input min=\"1\"\n                                max=\"255\"\n                                name=\"pause_hints_lockout_timer\"\n                                id=\"pause_hints_lockout_timer\"\n                                display_name=\"Hint Lockout Timer\"\n                                class=\"form-control center-div\"\n                                type=\"number\"\n                                data-toggle=\"tooltip\"\n                                title=\"The amount of seconds you will be locked out of closing the pause menu for viewing the hints screen (per set of 4) on the pause menu.\"\n                                default=\"1\"\n                                placeholder=\"1\"/>\n                    </div>\n                </div>\n            </div>\n            <div class=\"flex-container\">\n                <div class=\"form-check form-switch item-switch\">\n                    <label data-toggle=\"tooltip\"\n                            title=\"Hints are dimmed on the pause menu when a hint has been solved. Scouring and foolish hints will not dim.\">\n                        <input class=\"form-check-input\"\n                                type=\"checkbox\"\n                                name=\"dim_solved_hints\"\n                                display_name=\"Dim Solved Hints\"\n                                value=\"True\"\n                                />\n                        Dim solved hints\n                    </label>\n                </div>\n                <div class=\"form-check form-switch item-switch\">\n                    <label data-toggle=\"tooltip\"\n                            title=\"No joke hints will be placed.\">\n                        <input class=\"form-check-input\"\n                                type=\"checkbox\"\n                                name=\"serious_hints\"\n                                display_name=\"No Joke Hints\"\n                                value=\"True\"\n                                />\n                        No Joke Hints\n                    </label>\n                </div>\n                <div class=\"form-check form-switch item-switch\">\n                    <label data-toggle=\"tooltip\"\n                            title=\"Disables the check on Wrinkly Doors for having the appropriate kong unlocked.\">\n                        <input class=\"form-check-input\"\n                                type=\"checkbox\"\n                                name=\"wrinkly_available\"\n                                display_name=\"Kongless Hint Doors\"\n                                value=\"True\"/>\n                        Kongless Hint Doors\n                    </label>\n                </div>\n                <div class=\"form-check form-switch item-switch\">\n                    <label data-toggle=\"tooltip\"\n                            title=\"This option will add hints as to what move you are purchasing in shops.\">\n                        <input class=\"form-check-input\"\n                                type=\"checkbox\"\n                                name=\"enable_shop_hints\"\n                                display_name=\"Enable Shop Hints\"\n                                value=\"True\"/>\n                        Enable Shop Hints\n                    </label>\n                </div>\n            </div>\n            <div class=\"flex-container\">\n                <div class=\"item-select\">\n                    <p class=\"select-title\">Spoiler Hints</p>\n                    <select name=\"spoiler_hints\"\n                            id=\"spoiler_hints\"\n                            display_name=\"Spoiler Hints\"\n                            class=\"form-select\"\n                            aria-label=\"Randomization type\"\n                            data-toggle=\"tooltip\"\n                            title=\"Adds hints to the spoiler log that reveals specific information about the seed.&#10;Vials - Kongs, Keys, and vials will be revealed for each level. Shopkeeps appear as Kongs, and The Bean appears as a clear vial.&#10;Points - Each level has a number of points assigned to it based on the items the level contains. The point values for each item can be customized with the gear.\">\n                        <option value=\"vial_colors\">\n                            Vials\n                        </option>\n                        <option selected value=\"points\">\n                            Points\n                        </option>\n                        <option selected value=\"off\">\n                            Off\n                        </option>\n                    </select>\n                    <div>\n                    Customize Points\n                    ";
output += runtime.suppressValue((lineno = 432, colno = 42, runtime.callWrap(t_5, "properties_selector", context, [runtime.contextOrFrameLookup(context, frame, "points_spread"),"points_list","POINTS SPREAD","This will open a popup that will let you customize your points spread."])), env.opts.autoescape);
output += "\n                    ";
...
output += runtime.suppressValue((lineno = 194, colno = 36, runtime.callWrap(t_6, "item_req_selector", context, ["cb_medal_behavior_new","medal_cb_req","Colored Bananas for a Medal",1,100,"Determines how Medal requirements are determined."])), env.opts.autoescape);
output += "\n                <div class=\"item-select\">\n                    <div class=\"mx-auto\">\n                        <div>\n                            <p class=\"select-title\">Half Medal Percentage</p>\n                            <input name=\"half_medal_percentage\"\n                                    id=\"half_medal_percentage\"\n                                    type=\"number\"\n                                    display_name=\"Half Medal Percentage\"\n                                    class=\"form-control me-2\"\n                                    aria-label=\"Half Medal Percentage\"\n                                    data-toggle=\"tooltip\"\n                                    title=\"The percentage of the full medal colored banana requirement that the half medal will require.\"\n                                    min=\"1\"\n                                    max=\"99\"\n                                    value=\"50\"\n                            />\n                        </div>\n                    </div>\n                </div>\n            </div>\n        </div>\n        <div class=\"col border panel\">\n            <h2 class=\"title\">OVERWORLD REQUIREMENTS</h2>\n            <div class=\"flex-container\">\n                <div class=\"form-check form-switch item-switch\">\n                    <label data-toggle=\"tooltip\"\n                            title=\"All lobbies will be open as if the key to K. Lumsy was already turned in.&#10;This does not affect K. Rool's ship.\">\n                        <input class=\"form-check-input\"\n                                type=\"checkbox\"\n                                name=\"open_lobbies\"\n                                display_name=\"Open Lobbies\"\n                                value=\"True\"/>\n                        Open Lobbies\n                    </label>\n                </div>\n                ";
var tasks = [];
tasks.push(
function(callback) {
...
output += runtime.suppressValue((lineno = 245, colno = 31, runtime.callWrap(t_5, "toggle_input", context, ["shops_dont_cost","Tooie-Style Shops","Shops will not deduct coins from the player, but will require a certain amount of coins to purchase the item, akin to Banjo-Tooie's Jamjars silos."])), env.opts.autoescape);
output += "\n                ";
output += runtime.suppressValue((lineno = 246, colno = 31, runtime.callWrap(t_5, "toggle_input", context, ["free_trade_setting","Free Trade Agreement","Allow Kongs to pick up items assigned to other kongs."])), env.opts.autoescape);
output += "\n            </div>\n            <div class=\"flex-container\">\n                ";
output += runtime.suppressValue((lineno = 249, colno = 41, runtime.callWrap(t_10, "dropdown_multiselector", context, [runtime.contextOrFrameLookup(context, frame, "remove_barriers"),"remove_barriers","Remove Barriers","This will open a dropdown that will let you customize what barriers are removed.",12,1])), env.opts.autoescape);
...
output += runtime.suppressValue((lineno = 332, colno = 41, runtime.callWrap(t_10, "dropdown_multiselector", context, [runtime.contextOrFrameLookup(context, frame, "faster_checks"),"faster_checks","Faster Checks","This will open a dropdown that will let you customize what checks are sped up.",12,1])), env.opts.autoescape);
